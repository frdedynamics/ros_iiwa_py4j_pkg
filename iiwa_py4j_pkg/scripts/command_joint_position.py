...
from iiwa_py4j_pkg.msg import JointCommandPosition
...
def callback(data):
    ...
    FRI.setCommandedJointPosition(double_array)


def listener():
    """ function docstring, yo! """
    rospy.init_node('kuka_position_control', anonymous=True)
    rospy.Subscriber("cmd_pos", JointCommandPosition, callback)
    rospy.spin()
